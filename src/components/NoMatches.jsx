export default function NoMatches({ show, search, keywords }) {
    ...
    if (keywordsArr.length) {
      ...
      if (!search) message = `Não foi possível encontrar nenhum quebra-cabeças que contenha ${keywordsStr}!`;
    else message = `Não foi possível encontrar nenhum quebra-cabeças com esse nome que contenha ${keywordsStr}!`;
    }
